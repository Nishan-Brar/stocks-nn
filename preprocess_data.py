...
def split_column_evenly_and_calculate_gradients(i, number_of_lines, filtered_dates_and_stocks_np, price_after_one_year, current_prices):
...
def preprocess_data(d, stocks_np, number_of_years_to_consider, number_of_lines, features_subset_indexes, features_np,
    ...
    for i in iters:
        ...
        row = split_column_evenly_and_calculate_gradients(i, number_of_lines, filtered_dates_stocks_np, price_after_one_year, current_prices)
